...
[NAV] = LAYOUT_miryoku(
KC_ESC,            KC_1,              KC_2,              KC_3,              KC_4,               KC_5,              KC_6,              KC_7,              KC_8,              KC_9,              KC_0,              KC_BSPC,
U_NP, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_INS,  DF(GAMING_QWERTY),    DF(QWERTY),    DF(GAMING_COLEMAK),    DF(COLEMAK),    RESET, U_NP,
...
KC_ESC,            KC_1,              KC_2,              KC_3,              KC_4,               KC_5,              KC_6,              KC_7,              KC_8,              KC_9,              KC_0,              KC_BSPC,
U_NP, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, U_NU,    U_NA,    U_NA,    U_NA,    U_NA,    RESET,U_NP,
